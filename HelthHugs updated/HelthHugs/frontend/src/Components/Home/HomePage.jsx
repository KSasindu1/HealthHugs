    ...
    <div>
        ...
        <div className="cover_home">
          <div>
            <p className="home_topicc">
              Health<span className="home_subtopic">hugs</span>
            </p>
      ...
      <div className="section" id="services">
        ...
        <div className="hoomset">
          ...
          <div
            className="card_home"
            onClick={() => (window.location.href = "/denntalHome")}
          >
      ...
      <div className="bkselct" id="about">
        <div className="section ">
          ...
          <p className="about_us">
            HealthHugs is a leading, innovative healthcare management platform
            ...
            advanced technology and data-driven insights, HealthHugs helps
            ...
            exceptional care. Partner with HealthHugs for a healthier, more
      ...
      <footer className="foooter">
        <p>© 2024 HealthHugs. All rights reserved.</p>
      </footer>
    </div>
  );
}
