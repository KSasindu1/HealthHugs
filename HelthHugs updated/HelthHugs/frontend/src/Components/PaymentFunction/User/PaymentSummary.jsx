...
function PaymentSummary() {
  ...
  const calculateFees = (amount) => {
    const hospittelFee = amount * 0.02; // 2% of total amount
    const channelingFee = amount * 0.01; // 1% of total amount
    const tax = amount * 0.01; // 1% of total amount
    const total = amount + hospittelFee + channelingFee + tax; // amount + all fees
              ...
              {paymentData.paymentMethod === "cash" ? (
                ...
                <>
                  ...
                  <div className="paymnt_smury">
                    {paymentData.amount &&
                      (() => {
                        const { hospittelFee, channelingFee, tax } =
                        ...
                        return (
                          <>
                            ...
                            <div>
                              <p>Rs. {hospittelFee}</p>
                              <p>Rs. {channelingFee}</p>
                              <p>Rs. {tax}</p>
                              <p>Rs. {paymentData.amount}.00</p>
                            </div>
                          </>
                        );
                      })()}
